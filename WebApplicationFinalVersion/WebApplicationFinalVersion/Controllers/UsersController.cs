...
namespace WebApplicationFinalVersion.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> CreateUser([Bind("Username,Email,Password,Role,Userid,ImageFile")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Username,Email,Password,Role,ImageFile")] User user)
        {
            user.Userid = id;
            //if (ModelState.IsValid)
            {
