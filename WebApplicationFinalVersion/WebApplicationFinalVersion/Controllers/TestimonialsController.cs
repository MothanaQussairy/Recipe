...
namespace WebApplicationFinalVersion.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Userid,Content,Testimonialid")] Testimonial testimonial)
        {
            testimonial.Userid = HttpContext.Session.GetInt32("id");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userid,Content,Testimonialid")] Testimonial testimonial)
        {
